    ...
    try {
        const response = await fetch(`${API_URL}/${url}`, {
            ...
            headers: {
                ...
                'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwicm9sZSI6ImFkbWluX3N1cGVyIiwiaWF0IjoxNzM0NzU1ODQ0LCJleHAiOjE3MzQ4NDIyNDR9.x_Ye3sfDgkZ7freWQ5n0BIGUOEN1NrvFg5RKe5b0vrU',
            },
...
export const postFiles = async (url:string, data:FormData) => {
    try {        
        const response = await fetch(`${API_URL}/${url}`, {
            method: 'POST',
            headers: {
